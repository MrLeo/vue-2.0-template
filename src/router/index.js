...
export default new Router({
    ...
    routes: [
        ...
        {name: 'index', path: '/', component: resolve => require(['views/index.vue'], resolve)},// AMD 风格的异步组件
        {name: 'articale', path: '/articale/:title', component: resolve => require(['views/artical.vue'], resolve)},
